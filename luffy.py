...
os.environ['JAVA_HOME'] = r'C:\Users\shrey\.jdks\corretto-1.8.0_502'        #  <----- 🔴JAVA PATH🔴
######################🔴🔴🔴################################
...
df2 = spark.createDataFrame(data2, ["id", "name1"])
...
procdf = joindf.withColumn("comment",expr("""
...
finaldf = procdf.drop("name","name1").filter(" comment != 'Matched'")
